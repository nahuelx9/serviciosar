...
public interface ServicioDao extends JpaRepository<Servicio, Integer> {
    ...
    @Modifying
    @Query(value = "UPDATE servicio SET nombre=?,celular=?,whatsapp=?,email=?,categoria=?,precio=?,precio_descripcion=?,horario=?,descripcion=?,id_usuario=? where id_servicio=?",nativeQuery= true)
   public void actualizarServicio(String nombre, String celular,boolean whatsaap,String email,String categoria,String precio,String precio_descripcion, String horario, String descripcion,int id_usuario,int id_servicio);
 ...
 public Page<Servicio> findByPrecioHorario(String horario,String precio,Pageable pageable);
     ...
     @Query(value = "SELECT  * FROM  servicio WHERE concat(nombre,' ',categoria) LIKE %?%", nativeQuery = true)
  public Page<Servicio> findByNombre(@Param("nombre") String nombre, Pageable pageable);
   
    /*Buscar por todos los filtros  y   el  nombre*/
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario  AND  usuario.provincia =?   AND  usuario.departamento = ? AND  horario = ? AND precio IS NULL OR precio<=?  AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%  GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findAllAndName( String provincia, String departamento, String horario,String precio, String nombre,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario   AND  usuario.provincia =?   AND  usuario.departamento = ? AND  horario = ? AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%  GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findByNombreProvinciaDepartamentoHora( String provincia, String departamento, String horario, String nombre,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario  AND  usuario.provincia =?   AND  usuario.departamento = ? AND   concat(servicio.nombre,' ',servicio.categoria) LIKE %?%  GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findByNombreProvinciaDepartamento( String provincia, String departamento,String nombre,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario AND  concat(servicio.nombre,' ',servicio.categoria) LIKE %?%    AND  usuario.provincia =?  GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findByNombreProvincia(String nombre, String provincia,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%    LIKE  %?%  AND  usuario.departamento = ?  GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findByNombreDepartamento(String nombre,  String departamento,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario  AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%     AND  horario = ? GROUP BY id_servicio", nativeQuery = true)
 public Page<Servicio> findByNombreHora(String nombre,  String horario,Pageable pageable);
   
     /*Buscar por  el  nombre, precio*/
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario   AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%    AND precio IS NULL OR precio<=? GROUP BY id_servicio ORDER BY precio desc", nativeQuery = true)
 public Page<Servicio> findByNombrePrecio(String nombre, String precio,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario  AND  usuario.provincia =?    AND  horario = ? AND precio IS NULL OR precio<=? AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%   GROUP BY id_servicio ", nativeQuery = true)
 ...
 /*Buscar por nombre,horario,precio*/
   @Query(value = "SELECT   * FROM  servicio WHERE   horario = ? AND precio IS NULL OR precio<=?   AND  concat(nombre,' ',categoria) LIKE %?%  ", nativeQuery = true)
 public Page<Servicio> findByNombreHorarioPrecio(String horario,String precio,String nombre,Pageable pageable);
   ...
   @Query(value = "SELECT   * FROM  servicio INNER JOIN usuario ON servicio.id_usuario = usuario.id_usuario   AND  usuario.provincia =?   AND precio IS NULL OR precio<=? AND concat(servicio.nombre,' ',servicio.categoria) LIKE %?%    GROUP BY id_servicio ", nativeQuery = true)
